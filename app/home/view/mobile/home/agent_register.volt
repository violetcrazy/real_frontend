...
{% block top_meta %}
    <link rel="canonical" href="{{ url({ 'for' : 'agent_register' }) }}" />
{% endblock %}
{% block content %}
    <div class="block-header-tab layout-2"><a class="active item">Đại lý</a><a href="{{ url({ 'for' : 'user_register' }) }}" class="item">Người dùng</a>

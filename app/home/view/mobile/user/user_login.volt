...
{% block content %}
    <div class="block-header-tab layout-2"><a href="{{ url({ 'for' : 'agent_login' }) }}" class="item">Đại lý</a><a
                href="{{ url({ 'for' : 'user_login' }) }}" class="active item">Người dùng</a>
    ...
    <div class="main-content">
        <div class="form-custom m-t-15">
            ...
            <form id="form_signin">
                ...
                <div class="text-center m-b-20">Don't have an account? &#160<a href="{{ url({ 'for' : 'user_register'}) }}"><b class="text-danger">Sign up</b></a></div>
            </form>
        </div>
    </div>

...
{% block content %}
    <div class="main-content">
        ...
        <div class="row">
            ...
            <form class="form-contact form-custom m-b-10" method="POST" action="{{ url({'for': 'contact'}) }}" enctype="multipart/form-data">
                <div class="form-group m-b-10 {{ response['result']['name'] is defined ? 'has-error' : '' }}"><small>Tên</small>
                ...
                <div class="form-group m-b-10 {{ response['result']['email'] is defined ? 'has-error' : '' }}"><small>Email</small>
                ...
                <div class="form-group m-b-10 {{ response['result']['title'] is defined ? 'has-error' : '' }}"><small>Tiêu đề</small>
                ...
                <div class="form-group m-b-10 {{ response['result']['content'] is defined ? 'has-error' : '' }}"><small>Nội dung</small>
                ...
                <div class="action-bottom text-center">
                    <button type="submit" id="send-mail" class="btn esta-button btn-small ">Gửi</button>
                </div>
            </form>
        </div>
    </div>

        ...
        <div class="row">
            ...
            <div class="col-xs-9 single-user">
                <div class="breadcrumbs">
                    <div class="container"><a href="">THÀNH VIÊN</a><span class="symbol">></span><a href="" class="current">CĂN HỘ ĐÃ LƯU</a>
                    </div>
                </div>
                <h2 class="title-block title-page n-m-b">CĂN HỘ ĐÃ LƯU</h2>
                            ...
                            {% for item in apartment %}
                                <div class="item">
                                    ...
                                    <div class="summary">
                                        ...
                                        <a href="{{ url({'for': 'apartment_detail', 'slug': item['slug'], 'id': item['id']}) }}" class="esta-button btn">Xem chi tiết</a>
                                        <!--

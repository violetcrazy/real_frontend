...
{% block title %}Danh sách lưu kết quả tìm kiếm{% endblock %}
{% block description %}Danh sách lưu kết quả tìm kiếm{% endblock %}
{% block keywords %}Danh sách lưu kết quả tìm kiếm{% endblock %}
            ...
            <div class="col-xs-9 single-user">
                ...
                {% if listSaveSearch['result'] is empty %}
                    <div class="table-content2 m-t-30">
                        Bạn chưa lưu kết quả tìm kiếm nào
                    </div>
                {% else %}

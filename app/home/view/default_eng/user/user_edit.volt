        ...
        <div class="row">
            ...
            <div class="col-xs-9 single-user">
                <div class="breadcrumbs">
                    <div class="container"><a href="">USER</a><span class="symbol">></span><a href="" class="current">SETTING</a>
                    </div>
                </div>
                <h2 class="title-block title-page">SETTING</h2>
                <form class="form-horizontal dropdown-select-control select-scroll" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="firstname" class="col-sm-2 text-left control-label">First Name</label>
                        <div class="col-sm-8">
                            <input type="text" id="fristname" name="firstname" value="{{ user['firstname'] }}" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="username" class="col-sm-2 text-left control-label">Last Name</label>
                        <div class="col-sm-8">
                            <input type="text" id="username" name="lastname" value="{{ user['name'] }}" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="password" class="col-sm-2 text-left control-label">Password</label>
                        <div class="col-sm-8">
                            <input type="password" id="password" name="password" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="birthday" class="col-sm-2 text-left control-label">Birthday</label>
                        <div class="col-xs-8">
                            <div class="row-10">
                                <div class="col-xs-4">
                    ...
                    <div class="form-group">
                        <label for="phone" class="col-sm-2 text-left control-label">Phone</label>
                        <div class="col-sm-8">
                            <input type="text" id="phone" name="phone" value="{{ user['phone'] }}" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="name" class="col-sm-2 text-left control-label">City</label>
                        <div class="col-xs-8">
                            <div class="row-10">
                                <div class="col-xs-4">
                    ...
                    <div class="form-group">
                        <label for="job_title" class="col-sm-2 text-left control-label">Job</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label for="experience" class="col-sm-2 text-left control-label">Experience</label>
                        <div class="col-sm-8">
                            <input type="text" id="job_title" name="experience" value="{{ user['experience']}} " class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="description" class="col-sm-2 text-left control-label">Introduce</label>
                        <div class="col-sm-8">
                            ...
                            <div class="row-10">
                                <div class="col-xs-4 checkbox-medium-size">
                                    <label for="save_search_on" class="custom-checkbox">
                                        ...
                                        <span class="mark"></span><span class="text">On</span>
                                    </label>
                                </div>
                                <div class="col-xs-4 checkbox-medium-size">
                                    <label for="save_search_off" class="custom-checkbox">
                                        ...
                                        <span class="mark"></span><span class="text">Off</span>
                                    </label>
                                </div>
                            ...
                            <div class="row-10">
                                ...
                                <div class="col-xs-4 size-check-box">
                                    <div class="dropdown custom-select">
                                        ...
                                        <ul aria-labelledby="type-project" class="dropdown-menu">
                                            <li><a href="" data-value="0">Dailly</a></li>
                                            <li><a href="" data-value="1">Weekly</a></li>
                                            <li><a href="" data-value="2">Mothly</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>

...
{% block title %}Danh sách Apartment đã lưu{% endblock %}
{% block description %}Danh sách Apartment đã lưu{% endblock %}
{% block keywords %}Danh sách Apartment đã lưu{% endblock %}
                ...
                <div class="entry-sidebar">
                    <div class="content-block sidebar-user">
                        <div class="avatar">
                            ...
                            {% else %}
                                {% set avatar = config.asset.frontend_url ~ 'img/noimage.jpg' %}avatar.png' %}
                            {% endif %}
                            <img src="{{ avatar }}">
                        </div>
                        ...
                        <ul class="menu-user list-unstyled">
                            ...
                            {% endif %}
                            {% if userName == 'user' and userAction == 'purchasedPropertiesByAgent' %}
                            <li><a href="{{ url({'for' : 'user_purchased_properties_by_agent', 'id' : id}) }}"  class="active">Purchased Properties</a></li>
                            {% else %}
                            <li><a href="{{ url({'for' : 'user_purchased_properties_by_agent', 'id' : id}) }}">Purchased Properties</a></li>
                            {% endif %}
                            {% if userName == 'user' and userAction == 'saveHomeByAgent' %}
                            <li><a href="{{ url({'for' : 'user_save_home_by_agent', 'id' : id}) }}"  class="active">Save Homes</a></li>
                            {% else %}
                            <li><a href="{{ url({'for' : 'user_save_home_by_agent', 'id' : id}) }}">Save Homes</a></li>
                            {% endif %}
                        </ul>
                    </div>
                </div>

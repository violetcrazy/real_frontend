        ...
        <div class="row">
            ...
            <div class="col-xs-9 single-user">
                <div class="breadcrumbs">
                    <div class="container"><a href="">User</a><span class="symbol">></span><a href="" class="current">Contact customer</a>
                    </div>
                </div>
                                    ...
                                    {% for item in result['result'] %}
                                        <div class="item" data-info-customer='{{ item|json_encode }}'>
                                            <div class="thumbnail">
                                                ...
                                                <a class="ranking delete-contact" data-id="{{ item['id'] }}">Delete</a>
                                            </div>
                                            <div class="summary">
                        ...
                        <form action="" id="add-customer-user" class="m-b-20 form-custom" style="width:320px;">
                            <div class="inner15">
                                ...
                                <div class="line-input m-t-10">
                                    <label>Name</label>
                                    <input required type="text" name="name" placeholder="Name" class="esta-input">
                                </div>
                                <div class="line-input m-t-10">
                                    <label>Phone</label>
                                    <input type="text"  name="phone" placeholder="Phone" class="esta-input">
                                </div>
                                <div class="line-input m-t-10">
                                    <label>Email</label>
                                    <input required type="email" name="email" placeholder="Email" class="esta-input">
                                </div>
                                <div class="line-input m-t-10">
                                    <label>Address</label>
                                    <input type="text" name="address" placeholder="Address" class="esta-input">
                                </div>
                                <div class="line-input m-t-10">
                                ...
                                <div class="line-input m-t-10 text-right">
                                    <button type="submit" class="link-action esta-button  btn-small text-center">Save contact</button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div style="display: none;">
                    <form action="" id="send_email_contact" class="form-horizontal form-custom" style="width: 320px;">
                        <div class="inner15">
                            <h4 class="title-popup">Send email contact</h4>
                            <input type="hidden" name="email" id="email_customer" value="" >
                            <div class="input-line">
                                <div class="input-contact">
                                    <div class="text-label">Title</div>
                                    <input placeholder="title" type="text" name="title" value="" id="title-email" class="form-control" />
                                </div>
                            </div>
                            <div class="input-line">
                                <div class="input-contact">
                                    <div class="text-label">Content</div>
                                    <textarea placeholder="Content" name="content" style="height: 100px" class="form-control"></textarea>
                                </div>
                            </div>
                            <div class="text-right">
                                <button type="submit" class="btn esta-button btn-small">Send email</button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.delete-contact').on('click', function(event) {
                ...
                var r = '';
                r = confirm('Are you sure delete this customer?');

...
{% block title %}Find Agent{% endblock %}
{% block description %}Find Agent{% endblock %}
{% block keywords %}Find Agent{% endblock %}
...
{% block content %}
    <div class="container m-b-30">
        <div class="single-user">
            <h2 class="title-block title-page">Find Agent</h2>
                        ...
                        {% for item in list_agent['items'] %}
                            <div class="item">
                                ...
                                <div class="summary">
                                    ...
                                    <a href='{{ url({'for' : 'user_detail', 'id' : item['id']}) }}' class="esta-button btn">View detail</a>
        ...
        <div role="document" class="modal-dialog">
            <div style="width: 650px" class="modal-content">
                ...
                <div class="modal-body">
                    <h3 class="title-model">Contact Agent</h3>
                    ...
                    <form class="form-horizontal custom-from" id="send_mail_contact">
                        ...
                        <div class="row">
                            <div class="col-xs-4">
                                <div class="input-contact">
                                    ...
                                    <input placeholder="Name" type="text" id="name" name='name' value="{{ userSession is defined ? userSession['name'] : '' }}" class="form-control" />
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="input-contact">
                                    <div class="text-label">Phone</div>
                                    <input placeholder="Phone" type="text" name="phone" value="{{ userSession is defined ? userSession['phone'] : '' }}" id="phone" class="form-control" />
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="input-contact">
                                    <div class="text-label">Email</div>
                                    <input placeholder="Email" type="text" name="email" value="{{ userSession is defined ? userSession['email'] : '' }}" id="email" class="form-control" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="m-t-15">
                            <div class="input-contact">
                                ...
                                <textarea placeholder="Content" name="content" rows="5" class="form-control"></textarea>
                            </div>
                        </div>
                            ...
                            if (response.status == 200) {
                                var html = '\
                                        <div class="intro-form text-center">\
                                            <h3 class="title-center">Contact Agent</h3>\
                                            <div class="text-intro">Success.</div>\

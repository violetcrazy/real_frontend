...
<div class="row-section">
    <div class="container">
        <h2 class="title-block">Project</h2>
        <div class="list-post1">
            {% if project[0] is defined %}
                <div class="item item-3">
                    {% set _project = project[0] %}
                    {% include '/default_eng/component/project/_col_12.volt' %}
                    {% set _project = '' %}
                </div>
            {% endif %}
            ...
            <div class="row">
                ...
                <div class="item item-2 col-xs-8">
                    ...
                    {% include '/default_eng/component/project/_col_8.volt' %}
                    {% set _project = '' %}
                </div>
                {% endif %}
                ...
                <div class="item item-1 col-xs-4">
                    ...
                    {% include '/default_eng/component/project/_col_4.volt' %}
                    {% set _project = '' %}
                </div>
                {% endif %}
            </div>

...
<div class="footer-site">
    <div class="container">
        <div class="row address">
            <div class="col-xs-4">
                <div class="entry">
                    {{ options['footer1_en'] is defined and options['footer1_en']['value'] is not empty ? options['footer1_en']['value'] : '' }}
                </div>
            </div>
            <div class="col-xs-4">
                <div class="entry">
                    {{ options['footer2_en'] is defined and options['footer2_en']['value'] is not empty ? options['footer2_en']['value'] : '' }}
                </div>
            </div>
            <div class="col-xs-4">
                <div class="entry phone">
                    {{ options['footer3_en'] is defined and options['footer3_en']['value'] is not empty ? options['footer3_en']['value'] : '' }}
                </div>
            </div>
        </div>

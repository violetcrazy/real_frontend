        ...
        <h2 class="title-block title-page">
            ...
            <div class="pull-right">
                ...
                <div class="dropdown custom-select select-scroll" id="goto-slide">
                    <input type="hidden" name="location" value="" />
                    <button type="button" id="location" data-toggle="dropdown" data-id="{{ blocks['project_id']  }}" aria-haspopup="true" aria-expanded="false" class="btn btn-default btn-block dropdown-toggle">
                        <span class="text">
                            ...
                            {% for floorView in planView  %}
                                <li>
                                    <a href="" data-index="{{ loop.index }}">
                                        {{ floor_name_list[floorView['floor']] is defined and floor_name_list[floorView['floor']] ? floor_name_list[floorView['floor']] : 'Floor ' ~ floorView['floor'] }}  &#160 &#160
                                    </a>
                                </li>
                            {% endfor %}
                        {% endif %}
